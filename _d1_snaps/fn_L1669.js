function buildComDesignExecutive(data, options) {
    ...
    /* CSS gradient for browsers; Outlook paste uses the navy/teal cells below */
    ...
    const wmW = 280;
    /* Soft white shade + CSS watermark for preview; real <img> travels in Outlook paste */
    ...
    <table class="sig-com-executive sig-premium-exec sig-com-classic" cellpadding="0" cellspacing="0" border="0" width="${width}"
        ...
        <td colspan="2" class="sig-com-exec-top" bgcolor="#FFFFFF" background="${bgSrc}" style="${topBgStyle}padding:0;">
          <table cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse:collapse;width:100%;">
            <tr>
              ...
              <td width="${logoColW}" valign="middle" align="center" bgcolor="#FFFFFF" background="${bgSrc}"
                style="width:${logoColW}px;padding:10px 4px 10px 0;vertical-align:middle;text-align:center;background-color:transparent;">
                  ...
                  <tr>
                    <td align="center" style="padding:0;line-height:0;font-size:0;text-align:center;">
                      <img src="${bgSrc}" alt="" width="${wmW}" border="0"
                        ...
                        style="display:block;border:0;margin:0 auto;width:${wmW}px;max-width:${wmW}px;height:auto;opacity:0.20;filter:alpha(opacity=20);-ms-interpolation-mode:bicubic;" />
                    </td>
                  </tr>
                  <tr>
                    <td align="center" style="padding:0;line-height:0;font-size:0;text-align:center;background:transparent;">
                      <a href="${escapeHtml(data.websiteUrl)}" target="_blank" style="text-decoration:none;border:0;background:transparent;">
                        <img src="${logoSrc}" alt="Tattvam Markets" width="${logoW}" height="${logoH}" border="0"
                          ...
                          style="display:block;border:0;margin:-78px auto 0 auto;width:${logoW}px;height:${logoH}px;background:transparent;-ms-interpolation-mode:bicubic;" />
                      </a>
                    </td>
                  </tr>
                </table>
      ...
      <tr>
        ...
        <td width="${footerLeftW}" bgcolor="${COM_NAVY}"
          style="width:${footerLeftW}px;${navyBg}${footerBg}padding:10px 8px 10px 16px;mso-color-alt:${COM_NAVY};">
        ...
        <td width="${footerRightW}" bgcolor="${COM_TEAL}" align="center"
          style="width:${footerRightW}px;${tealBg}padding:10px 12px;text-align:center;white-space:nowrap;mso-color-alt:${COM_TEAL};">
