function buildComDesignExecutive(data, options) {
    ...
    const webStyle = `font-family:Arial,Helvetica,sans-serif;font-size:10px;font-weight:600;color:${COM_NAVY};text-decoration:none;line-height:1.3;mso-color-alt:${COM_NAVY};`;
