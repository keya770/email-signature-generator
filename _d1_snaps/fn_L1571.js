function buildComDesignExecutive(data, options) {
    ...
    const logoSrc = opts.logoDataUrl || iconMap[LOGO_FILE] || getAssetUrl(LOGO_FILE);
    const bgSrc = opts.design1BgDataUrl || getAssetUrl(DESIGN1_BG_FILE);
    /* Soft white veil + watermark — CSS for modern clients; <img> + bgcolor for Outlook */
    ...
    const footerGap = 18;
    const footerLeftW = width - accentW - 168;
            ...
            <tr>
              <td width="${midW}" valign="top" bgcolor="#FFFFFF"
                ...
                <table cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse:collapse;width:100%;">
                  ...
                  <tr>
                    <td class="sig-title-text" style="padding:8px 0 12px 0;${titleStyle}">
              ...
              <td width="${logoColW}" bgcolor="#FFFFFF" background="${bgSrc}" valign="middle" align="center"
                style="width:${logoColW}px;padding:14px 6px 12px 0;vertical-align:middle;text-align:center;background-color:#FFFFFF;background-image:url('${bgSrc}');background-repeat:no-repeat;background-position:center 40%;background-size:${wmW}px auto;">
                <table cellpadding="0" cellspacing="0" border="0" align="center" width="${logoColW}" style="border-collapse:collapse;margin:0 auto;width:${logoColW}px;">
                  <tr>
                    <td align="center" style="padding:0;line-height:0;font-size:0;text-align:center;">
                      <!-- Outlook-safe watermark (real img; CSS bg alone is stripped on paste) -->
                      <img src="${bgSrc}" alt="" width="${wmW}" border="0"
                        class="sig-com-exec-wm"
                        style="display:block;border:0;margin:0 auto -${Math.round(logoH * 0.72)}px auto;width:${wmW}px;height:auto;max-width:${wmW}px;opacity:0.22;filter:alpha(opacity=22);-ms-interpolation-mode:bicubic;" />
                    </td>
                  </tr>
                  <tr>
                    <td align="center" style="padding:0;line-height:0;font-size:0;text-align:center;background:transparent;">
                      <a href="${escapeHtml(data.websiteUrl)}" target="_blank" style="text-decoration:none;border:0;background:transparent;">
                        <img src="${logoSrc}" alt="Tattvam Markets" width="${logoW}" height="${logoH}" border="0"
                          ...
                          style="display:block;border:0;margin:0 auto;width:${logoW}px;height:${logoH}px;background:transparent;position:relative;z-index:2;-ms-interpolation-mode:bicubic;" />
                      </a>
                    </td>
                  </tr>
                </table>
