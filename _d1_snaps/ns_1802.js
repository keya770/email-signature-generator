    ...
    const identityStack = `
                <table cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse:collapse;width:100%;">
                  ...
                  <tr>
                    <td class="sig-title-text" style="padding:6px 0 8px 0;${titleStyle}">
          ...
          <table cellpadding="0" cellspacing="0" border="0" width="${width}" height="${footerH}"
            ...
            <tr>
              <td width="${width}" height="${footerH}" valign="middle"
                style="width:${width}px;height:${footerH}px;padding:0 18px 0 ${padL}px;vertical-align:middle;">
    ...
    <table class="sig-com-executive sig-premium-exec sig-com-classic" cellpadding="0" cellspacing="0" border="0" width="${outerW}"
      ...
      <tr>
        <td class="sig-com-exec-top" width="${width}" valign="top" style="width:${width}px;padding:0;vertical-align:top;">
          ${cardInner}
        </td>
