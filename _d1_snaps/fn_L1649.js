function buildComDesignExecutive(data, options) {
    ...
    const navyBg = buildAntiInvertBg(COM_NAVY);
    ...
    const wmW = 220;
    const topInnerW = width - accentW;
    /* Soft white shade + faint bg for modern clients; Outlook uses real <img> + VML below */
    ...
    const nameSideWhiteShade = `background-color:#FFFFFF;${whiteBg}`;
    ...
    const footerGap = 18;
    const footerRightW = 168;
    const footerLeftW = width - accentW - footerRightW;
    ...
    <table class="sig-com-executive sig-premium-exec sig-com-classic" cellpadding="0" cellspacing="0" border="0" width="${width}"
      ...
      <tr>
        ...
        <td colspan="2" class="sig-com-exec-top" bgcolor="#FFFFFF" background="${bgSrc}" width="${topInnerW}"
          style="width:${topInnerW}px;${topBgStyle}padding:0;">
          <!--[if gte mso 9]>
          <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="width:${topInnerW}px;height:210px;">
            <v:fill type="frame" src="${bgSrc}" color="#FFFFFF" origin="0.55,0.1" position="0.55,0.1" size="0.85,0.85" />
            <v:textbox inset="0,0,0,0" style="mso-fit-shape-to-text:true">
          <![endif]-->
          <table cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse:collapse;width:100%;">
            <tr>
              <td width="${midW}" valign="top" bgcolor="#FFFFFF"
                style="width:${midW}px;${nameSideWhiteShade}padding:18px 8px 14px 18px;vertical-align:top;">
                <table cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse:collapse;width:100%;">
              ...
              <td width="${logoColW}" bgcolor="#FFFFFF" background="${bgSrc}" valign="middle" align="center"
                style="width:${logoColW}px;padding:10px 6px 12px 0;vertical-align:middle;text-align:center;background-color:#FFFFFF;background-image:url('${bgSrc}');background-repeat:no-repeat;background-position:center 40%;background-size:${wmW}px auto;">
                <table cellpadding="0" cellspacing="0" border="0" align="center" width="${logoColW}" style="border-collapse:collapse;margin:0 auto;width:${logoColW}px;">
                  <tr>
                    <td align="center" style="padding:0;line-height:0;font-size:0;text-align:center;">
                      <img src="${bgSrc}" alt="" width="${wmW}" border="0"
                        class="sig-com-exec-wm"
                        style="display:block;border:0;margin:0 auto;width:${wmW}px;max-width:${wmW}px;height:auto;opacity:0.22;filter:alpha(opacity=22);-ms-interpolation-mode:bicubic;" />
                    </td>
                  </tr>
                  <tr>
                    <td align="center" style="padding:0;line-height:0;font-size:0;text-align:center;background:transparent;">
                      <a href="${escapeHtml(data.websiteUrl)}" target="_blank" style="text-decoration:none;border:0;background:transparent;">
                        <img src="${logoSrc}" alt="Tattvam Markets" width="${logoW}" height="${logoH}" border="0"
                          ...
                          style="display:block;border:0;margin:-70px auto 0 auto;width:${logoW}px;height:${logoH}px;background:transparent;-ms-interpolation-mode:bicubic;" />
                      </a>
                    </td>
                  </tr>
                </table>
      ...
      <tr>
        <td width="${accentW}" bgcolor="${COM_NAVY}" style="width:${accentW}px;${navyBg}padding:0;font-size:0;line-height:0;mso-color-alt:${COM_NAVY};">&nbsp;</td>
        <td width="${footerLeftW}" bgcolor="${COM_NAVY}"
          style="width:${footerLeftW}px;${navyBg}padding:10px 8px 10px 16px;mso-color-alt:${COM_NAVY};">
          <table cellpadding="0" cellspacing="0" border="0" role="presentation" style="border-collapse:collapse;background:transparent;">
            <tr>
              <td valign="middle" align="left" style="vertical-align:middle;text-align:left;padding:0;white-space:nowrap;">
                <font color="#FFFFFF" face="Arial, Helvetica, sans-serif" style="${footerTagStyle}"><span style="${footerTagStyle}">Trade Better</span></font>
              </td>
        ...
        <td width="${footerRightW}" bgcolor="${COM_TEAL}" align="center"
          style="width:${footerRightW}px;${tealBg}padding:10px 14px;text-align:center;white-space:nowrap;mso-color-alt:${COM_TEAL};">
